    ...
    <>
      <motion.div
        ...
        className={classNames(
          ...
          'bg-white/95 dark:bg-gray-950/95 border-r border-white/20 dark:border-gray-800/50',
          'backdrop-blur-xl shadow-2xl text-sm',
          'transition-all duration-300 ease-out',
          isSettingsOpen ? 'z-40' : 'z-sidebar',
        )}
      >
        <div className="h-14 flex items-center justify-between px-4 border-b border-white/10 dark:border-gray-800/50 bg-gradient-to-r from-purple-50/50 to-violet-50/50 dark:from-purple-900/20 dark:to-violet-900/20">
          <div className="dynamic-branding font-semibold text-lg">webdev.ai</div>
        ...
        <div className="flex-1 flex flex-col h-full w-full overflow-hidden">
          <div className="p-4 space-y-3">
            <div className="flex gap-2">
              <a
                href="/"
                className="flex-1 flex gap-2 items-center bg-gradient-to-r from-purple-50 to-violet-50 dark:from-purple-500/10 dark:to-violet-500/10 text-purple-700 dark:text-purple-300 hover:from-purple-100 hover:to-violet-100 dark:hover:from-purple-500/20 dark:hover:to-violet-500/20 rounded-xl px-4 py-2.5 transition-all duration-200 shadow-sm hover:shadow-md transform hover:scale-[1.02]"
              >
          ...
          <div className="flex-1 overflow-auto px-3 pb-3">
            ...
            <DialogRoot open={dialogContent !== null}>
              {binDates(filteredList).map(({ category, items }) => (
                <div key={category} className="mt-4 first:mt-0 space-y-2">
                  <div className="text-xs font-semibold text-purple-600 dark:text-purple-400 sticky top-0 z-1 bg-white/95 dark:bg-gray-950/95 backdrop-blur-sm px-4 py-2 rounded-lg mx-2">
                    {category}
                  </div>
                  ...
                  <>
                    <div className="p-6 bg-white dark:bg-gray-950">
                      ...
                      <DialogDescription className="mt-2 text-gray-600 dark:text-gray-400">
                        ...
                        <br />
                        <span className="mt-2 inline-block">Are you sure you want to delete this chat?</span>
                      </DialogDescription>
                    </div>
                  ...
                  <>
                    <div className="p-6 bg-white dark:bg-gray-950">
                      ...
                      <DialogDescription className="mt-2 text-gray-600 dark:text-gray-400">
                        ...
                        <span className="mt-3 inline-block">Are you sure you want to delete these chats?</span>
                      </DialogDescription>
                    </div>
                    <div className="flex justify-end gap-3 px-6 py-4 bg-gray-50 dark:bg-gray-900 border-t border-gray-100 dark:border-gray-800">
                      <DialogButton type="secondary" onClick={closeDialog}>
