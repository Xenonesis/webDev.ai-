...
export default function SettingsTab() {
  ...
  useEffect(() => {
    try {
      ...
      const existingProfile = JSON.parse(localStorage.getItem('webdev_ai_user_profile') || '{}');
      ...
      localStorage.setItem('webdev_ai_user_profile', JSON.stringify(updatedProfile));
