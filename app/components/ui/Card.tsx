  ...
  return (
    <div
      ...
      className={classNames(
        'rounded-xl border border-bolt-elements-borderColor bg-bolt-elements-background-depth-1 text-bolt-elements-textPrimary shadow-sm hover:shadow-md transition-all duration-200',
