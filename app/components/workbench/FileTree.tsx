...
export const FileTree = memo(
  ({
    ...
    return (
      <div className={classNames('text-sm', className, 'overflow-y-auto modern-scrollbar p-2 space-y-1')}>
  ...
  return (
    <button
      ...
      className={classNames(
        'flex items-center gap-1.5 w-full pr-2 border-2 border-transparent text-faded py-1 rounded-lg transition-all duration-200 hover:bg-bolt-elements-item-backgroundActive',
        className,
      )}
      style={{ paddingLeft: `${6 + depth * NODE_PADDING_LEFT}px` }}
      onClick={() => onClick?.()}
