...
const storedProfile = typeof window !== 'undefined' ? localStorage.getItem('webdev_ai_profile') : null;
...
export const updateProfile = (updates: Partial<Profile>) => {
  ...
  if (typeof window !== 'undefined') {
    localStorage.setItem('webdev_ai_profile', JSON.stringify(profileStore.get()));
  }
};
